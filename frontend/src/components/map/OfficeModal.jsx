...
const OfficeModal = ({ office: initialOffice, onClose }) => {
    ...
    useEffect(() => {
        const checkUser = async () => {
            try {
                ...
                console.error("Error validando admin en Modal:", error);
            }
        };
        checkUser();
    }, []);
    ...
    const handleSave = async () => {
        console.log("Guardando oficina en Supabase...", office);
        // await supabase.from('offices').update(office).eq('id', office.id);
        setIsEditing(false);
    };
        ...
        >
            ...
            >
                ...
                <div className="space-y-3 text-gray-700 mb-6">
                    ...
                    {/* COORDENADAS (Solo visibles en edición o para depuración) */}
                    {isEditing && (
                ...
                <div className="flex flex-col gap-3">
                    {/* Botón de Llamar - Oculto en edición */}
                    ...
                    {/* Botón de Cómo llegar - Oculto en edición */}
