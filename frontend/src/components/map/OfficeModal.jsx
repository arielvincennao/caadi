...
className="w-full bg-green-600 text-white text-center py-2 rounded-100 hover:bg-green-700 transition font-medium flex items-center justify-center gap-2"
>
