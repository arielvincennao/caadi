          ...
          {!isEditing ? (
            <>
              ...
              <button
                ...
                className="bg-red-600 text-white p-1 rounded-full shadow-md hover:bg-red-700 cursor-pointer"
                title="Eliminar Paso"
              >🗑</button>
            </>
          ) : (
            <div className="flex gap-1">
              ...
              <button onClick={handleDelete} className="bg-red-600 text-white px-2 py-0.5 rounded text-[10px] font-bold shadow-sm cursor-pointer">🗑</button>
            </div>
          )}
        </div>
      )}
