...
import Claim from './pages/claims/Claim.jsx'
  ...
  return (
    ...
    <AuthProvider>
      <Routes>
        ...
        <Route path="/agregar-seccion" element={<PrivateRoute><AddSection /></PrivateRoute>} />
        <Route path="/eliminar-seccion" element={<PrivateRoute><DeleteSection /></PrivateRoute>} />
      </Routes>
    </AuthProvider>
    </BrowserRouter>
  );
